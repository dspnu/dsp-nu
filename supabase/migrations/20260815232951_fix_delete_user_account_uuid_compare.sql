-- Fix delete_user_account: profiles.big/little are uuid, not text.
-- Comparing uuid = text raised "operator does not exist" which PostgREST
-- surfaces as RPC 404 (SQLSTATE 42883).
...
BEGIN
  ...
  -- Nullify big/little references (uuid columns)
