 ...
 * Links keep target="_blank" for web; on Capacitor native, clicks are delegated to openExternalUrl.
 */
export function MarkdownView({ source }: { source: string }) {
  ...
  const handleClick = (event: MouseEvent<HTMLDivElement>) => {
    ...
    void openExternalUrl(href.startsWith('http') ? href : anchor.href);
  };
