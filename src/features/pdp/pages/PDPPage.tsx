...
import { isPDPOfficer } from '@/config/org';
import { Navigate, Link } from 'react-router-dom';
import { PDPHome } from '@/features/pdp/components/PDPHome';
import { PDPCoffeeChats } from '@/features/pdp/components/PDPCoffeeChats';
import { PDPAssignments } from '@/features/pdp/components/PDPAssignments';
import { PDPResources } from '@/features/pdp/components/PDPResources';
import { PDPProgress } from '@/features/pdp/components/PDPProgress';
...
export default function PDPPage() {
  ...
  const isVP = isPDPOfficer(profile);
